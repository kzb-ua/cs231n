...
class KNearestNeighbor(object):
    ...
    def compute_distances_no_loops(self, X):
        ...
        #########################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ## (X-X_train) ^2 = X^2 +X_train**2 - 2*X_train*X
        sum_X_2 = np.sum(pow(X, 2), axis=1).reshape(-1, 1) 
        sum_X_train_2 = np.sum(pow(self.X_train,2), axis=1) 
